...
import { getInstructores as getInstructoresReservas } from '../service/reservas.Service.js';
...
function obtenerLicencia(instructor) {
  return instructor.especialidad
...
export default function InstructoresView({ sedeActiva }) {
  ...
  const cargarDatos = async () => {
    ...
    try {
      ...
      const data = normalizarLista(await getInstructoresReservas(sedeId));
